...
import { readComponentJson as actualReadComponentJson } from "./componentJsonIO.js";
 ...
 */
export function getInstanceDirectoryName(component, index, originalName) {
 ...
 */
export function getPrevIndex(component, forceCalc) {
 ...
 */
export async function keepLoopInstance(component, cwfDir) {
 ...
 */
export function forGetNextIndex(component) {
 ...
 * @returns {boolean} -
 */
export function forIsFinished(component) {
 ...
 */
export function forTripCount(component) {
 ...
 * @returns {number} - next index
 */
export function whileGetNextIndex(component) {
 ...
 * @returns {boolean} -
 */
export async function whileIsFinished(cwfDir, projectRootDir, component, env) {
 ...
 * @returns {number} - next index
 */
export function foreachGetNextIndex(component) {
 ...
 */
export function foreachGetPrevIndex(component, forceCalc) {
  if (!forceCalc && typeof component.prevIndex !== "undefined") {
    return component.prevIndex;
  }
 ...
 * @returns {boolean} -
 */
export function foreachIsFinished(component) {
 ...
 * @returns {boolean} -
 */
export function foreachTripCount(component) {
 ...
 * @returns {Promise} - resolved when unnecessary directories are removed
 */
export async function foreachKeepLoopInstance(component, cwfDir) {
  if (!Number.isInteger(component.keep) || component.keep <= 0) {
    return;
  }
 ...
 */
export async function foreachSearchLatestFinishedIndex(component, cwfDir) {
  let rt = null;
 ...
 */
export function loopInitialize(component, getTripCount) {
