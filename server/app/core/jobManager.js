...
const _internal = {
   ...
   */
  getFirstCapture: (outputText, reCode)=>{
   ...
   */
  getBulkFirstCapture: (outputText, reSubCode)=>{
   ...
   */
  getStatusCode: async (JS, task, statCmdRt, outputText)=>{
   ...
   * @param {object} JS - jobScheduler.json info
   */
  createRequestForWebAPI: (hostinfo, task, JS)=>{
   ...
   * @param {object} JS - jobScheduler.json info
   */
  createRequest: (hostinfo, task, JS)=>{
    return {
...
module.exports = {
  registerJob,
  getFirstCapture: _internal.getFirstCapture,
  getBulkFirstCapture: _internal.getBulkFirstCapture,
  isJobFailed: _internal.isJobFailed,
  getStatusCode: _internal.getStatusCode,
  createRequestForWebAPI: _internal.createRequestForWebAPI,
  createRequest: _internal.createRequest
};
