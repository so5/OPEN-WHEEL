 ...
 */
_internal.readJsonGreedy = async function (filename, retry) {
...
export const readJsonGreedy = _internal.readJsonGreedy;

/**
 * add execute permission to file
 * @param {string} file - filename in absolute path
 */
_internal.addX = async function (file) {
...
export const addX = _internal.addX;
