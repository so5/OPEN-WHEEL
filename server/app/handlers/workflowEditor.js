...
import { updateComponent as updateComponentCore, updateComponentPos as updateComponentPosCore } from "../core/updateComponent.js";
...
export async function onUpdateComponent(projectRootDir, ID, updated, parentID, cb) {
  return generalHandler(updateComponentCore.bind(null, projectRootDir, ID, updated), "updateComponent", projectRootDir, parentID, false, cb);
}
export async function onUpdateComponentPos(projectRootDir, ID, pos, parentID, cb) {
  return generalHandler(updateComponentPosCore.bind(null, projectRootDir, ID, pos), "updateComponentPos", projectRootDir, parentID, false, cb);
}
...
export async function onGetEnv(projectRootDir, ID, cb) {
  try {
    const env = await getEnvCore(projectRootDir, ID);
    return cb(env);
  } catch (e) {
