...
describe("#addProject", ()=>{
  ...
  beforeEach(()=>{
    ...
    removeTrailingPathSepStub = sinon.stub(projectFilesOperator._internal, "removeTrailingPathSep").callsFake((p)=>{ return p; });
    convertPathSepStub = sinon.stub(projectFilesOperator._internal, "convertPathSep").callsFake((p)=>{ return p; });
  });
